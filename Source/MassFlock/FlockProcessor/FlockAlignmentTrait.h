...
#include "FlockAlignmentTrait.generated.h"

USTRUCT()
struct FFlockAlignmentParameters : public FMassSharedFragment
{
	GENERATED_BODY()
...
USTRUCT()
struct FFlockAlignmentTag : public FMassTag
{
	GENERATED_BODY()
};

UCLASS(DisplayName = "Flock Alignment")
class MASSFLOCK_API UFlockAlignmentTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere)
	FFlockAlignmentParameters Parameters;
